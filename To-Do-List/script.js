...
//user lay kai task na lekhi add garna thalyo vani yo alert aauxa
function CreateToDoItems() {
  if (todoValue.value === "") {
    ...
    const todoItems = `<div title="Hit Double Click And Complete" ondblclick="CompletedToDoItems(this)">${todoValue.value}</div>
           <div><img class="edit todo-controls" onclick="UpdateToDoItems(this)" src="https://img.icons8.com/?size=100&id=11762&format=png&color=000000" />
           <img class="delete todo-controls" onclick="DeleteToDoItems(this)" src="https://img.icons8.com/?size=100&id=99961&format=png&color=000000" /></div></div>`;
